...
const ColorPicker = ({ setSubmitted, colorsArray }: any) => {
  ...
  return (
    <>
      {!state.loading ?
        <main className={`ma10`} >
          <h2 className={`mt8 mb3 t-heading-2 fw2 ${handles['colorPicker--title']}`}>Elegí tu color favorito</h2>
          <p className={`mb8 fw2 ${handles['colorPicker--title']}`}>Elegí tu color favorito y hace click en enviar para ver los resultados</p>
